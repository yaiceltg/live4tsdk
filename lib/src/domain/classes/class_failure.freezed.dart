...
/// @nodoc
class _$ClassFailureTearOff {
  const _$ClassFailureTearOff();
...
/// @nodoc
const $ClassFailure = _$ClassFailureTearOff();

/// @nodoc
mixin _$ClassFailure {
  @optionalTypeArgs
...
/// @nodoc
abstract class $ClassFailureCopyWith<$Res> {
  factory $ClassFailureCopyWith(
          ClassFailure value, $Res Function(ClassFailure) then) =
      _$ClassFailureCopyWithImpl<$Res>;
}

/// @nodoc
class _$ClassFailureCopyWithImpl<$Res> implements $ClassFailureCopyWith<$Res> {
  _$ClassFailureCopyWithImpl(this._value, this._then);

  final ClassFailure _value;
  // ignore: unused_field
  final $Res Function(ClassFailure) _then;
}
...
/// @nodoc
class __$HttpErrorCopyWithImpl<$Res> extends _$ClassFailureCopyWithImpl<$Res>
...
class _$_HttpError implements _HttpError {
  ...
  @override
  String toString() {
    return 'ClassFailure.http(error: $error)';
  }
...
abstract class _HttpError implements ClassFailure {
...
/// @nodoc
class __$UnknownCopyWithImpl<$Res> extends _$ClassFailureCopyWithImpl<$Res>
...
abstract class _Unknown implements ClassFailure {
