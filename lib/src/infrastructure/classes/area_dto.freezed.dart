...
class _$AreaDtoTearOff {
  ...
  _AreaDto call({required String name}) {
    return _AreaDto(
      name: name,
    );
  }
...
class _$_AreaDto extends _AreaDto {
  const _$_AreaDto({required this.name}) : super._();
...
abstract class _AreaDto extends AreaDto {
  const factory _AreaDto({required String name}) = _$_AreaDto;
